...
- [ ] Allow users to share a read-only link to their roadmap
- [ ] Add a "Rate My School" or review section per campus
- [ ] Add advisor view (view a student's roadmap with comment ability)
- [ ] Deploy frontend to Vercel and backend to Render
- [ ] Write full `README.md` with setup instructions and screenshots

**Suggested Commit Messages:**

```
feat: add dark mode toggle with persisted preference
feat: implement shareable read-only roadmap link
