...
const SchoolDetailPage = () => {
    ...
    return (_jsxs("div", { children: [_jsxs("section", { className: "relative overflow-hidden text-white", children: [_jsx("img", { src: campus.image, alt: "", "aria-hidden": "true", className: "absolute inset-0 h-full w-full object-cover" }), _jsx("div", { className: `absolute inset-0 ${campus.type === "Senior College"
