...
function App() {
    return (_jsx(DarkModeProvider, { children: _jsx(AuthProvider, { children: _jsxs(BrowserRouter, { children: [_jsxs("div", { className: "min-h-screen bg-white dark:bg-slate-900 text-gray-900 dark:text-white transition-colors", children: [_jsx(Navbar, {}), _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(LandingPage, {}) }), _jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/register", element: _jsx(RegisterPage, {}) }), _jsx(Route, { path: "/explore", element: _jsx(ExplorePage, {}) }), _jsxs(Route, { element: _jsx(ProtectedRoute, {}), children: [_jsx(Route, { path: "/dashboard", element: _jsx(DashboardPage, {}) }), _jsx(Route, { path: "/roadmap-builder", element: _jsx(RoadmapBuilderPage, {}) }), _jsx(Route, { path: "/roadmap/:id", element: _jsx(RoadmapBuilderPage, {}) }), _jsx(Route, { path: "/journey", element: _jsx(JourneyDashboardPage, {}) }), _jsx(Route, { path: "/advisor", element: _jsx(AdvisorDashboardPage, {}) })] })] })] }), _jsx(Toaster, {})] }) }) }));
}
export default App;
